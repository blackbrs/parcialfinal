...
public class ActualizarTabla1 extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public void cargarWebServiceLocal(View v){
        if(codmateria.getText().toString().isEmpty() || nommateria.getText().toString().isEmpty() || unidadesval.getText().toString().isEmpty() ){
            ...
            String url ="http://ca14080.000webhostapp.com/ws_update_materia.php?codmateria="+ codmateria.getText().toString()+
