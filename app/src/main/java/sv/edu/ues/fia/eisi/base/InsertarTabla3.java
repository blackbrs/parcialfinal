...
public class InsertarTabla3 extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    public void cargarWebServiceLocal(View v){
        if(codigomateria.getText().toString().isEmpty() || carnet.getText().toString().isEmpty() || ciclo.getText().toString().isEmpty()|| notafinal.getText().toString().isEmpty() ){
            ...
            String url ="http://ca14080.000webhostapp.com/ws_nota_insert.php?codmateria="+ codigomateria.getText().toString()+
